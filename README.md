...
**Bonsai KV defaults:** target K/V Q8_0, MTP draft K/V F16. The launcher accepts `-DraftKvType` to override the draft cache independently of `-KvType`; server/CLI accept `--spec-kv-dtype`. See the [F16 memory comparison](docs/bonsai-mtp1-f16-5060-comparison.md).
